...
# 3dsx
APP_TITLE	:=	Spooky's 3D Mansion
APP_DESCRIPTION	:=	A remake of Spooky's Jumpscare Mansion for 3DS
APP_AUTHOR	:=	Xorte
ICON		:=	3ds/res/icon.png
...
LIBS	:= -lcitro2d -lcitro3d -lfreetype -lpng -lbz2 -lopus -lm -lcurl -lmbedtls -lmbedx509 -lmbedcrypto -lz -lctru
